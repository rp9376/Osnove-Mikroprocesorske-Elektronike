...
void RN42BT::sendDataByte(byte val0, byte val1)
{
  ...
  BTserial.write(val1);
  BTserial.write(val0); // ships track because 0x0100 //it goes from back to front  //last bite goes first in the correct order //fucked indian
...
void RN42BT::connect()
{
  ...
  delay(100);
  BTserial.write(BP_CONNENT);
  //Serial.println("Connecting$$$CFI..");
}
