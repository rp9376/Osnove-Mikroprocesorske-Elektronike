...
V nadaljevanju bodite pozorni na sledeče koncepte:
	...
	1.	da parametre za delo z nekim objektom (v našem primeru s krivuljo) združujemo v strukture;
...
int main(void)
{
	...
	square_function_init( &parametri_krivulje, 1, -5, 2);
	...
	float y;
	y = square_function_value( &parametri_krivulje, 5 );
