...
int main(void)
{
	...
	prazniki_po_dnevih[Tuesday] 	= 1+1;		// prazniki na torek
	prazniki_po_dnevih[Wednesday] 	= 1;		// prazniki na sredo
	prazniki_po_dnevih[Thursday] 	= 0;		// prazniki na četrtek
	prazniki_po_dnevih[Friday] 	= 0;		// prazniki na petek
	prazniki_po_dnevih[Saturday] 	= 1+1;		// prazniki na soboto
	prazniki_po_dnevih[Sunday] 	= 1+1+1;	// prazniki na nedeljo
	

	
	// In ko želimo prebrati število praznikov za posamezen dan, uporabimo
	// seveda enak princip.
	printf("število praznikov na ponedeljek: %d\n", prazniki_po_dnevih[Monday]);
	printf("število praznikov na torek: %d\n", 		prazniki_po_dnevih[Tuesday]);
	printf("število praznikov na sredo: %d\n", 		prazniki_po_dnevih[Wednesday]);
	printf("število praznikov na četrtek: %d\n", 	prazniki_po_dnevih[Thursday]);
	printf("število praznikov na petek: %d\n", 		prazniki_po_dnevih[Friday]);
	printf("število praznikov na soboto: %d\n", 	prazniki_po_dnevih[Saturday]);
	printf("število praznikov na nedeljo: %d\n", 	prazniki_po_dnevih[Sunday]);
