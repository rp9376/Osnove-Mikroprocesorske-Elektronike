...
ErrorStatus LL_ADC_CommonInit(ADC_Common_TypeDef *ADCxy_COMMON,
	...
	if (ADC_CommonInitStruct->Multimode != LL_ADC_MULTI_INDEPENDENT) {
		...
		assert_param(
				IS_LL_ADC_MULTI_TWOSMP_DELAY(ADC_CommonInitStruct->MultiTwoSamplingDelay));
	}
#endif /* ADC_MULTIMODE_SUPPORT */
...
ErrorStatus LL_ADC_DeInit(ADC_TypeDef *ADCx) {
	...
	if (READ_BIT(ADCx->CR,
		...
		CLEAR_BIT(ADCx->CFGR2,
				(ADC_CFGR2_ROVSM | ADC_CFGR2_TROVS | ADC_CFGR2_OVSS | ADC_CFGR2_SWTRIG | ADC_CFGR2_BULB | ADC_CFGR2_SMPTRIG | ADC_CFGR2_GCOMP | ADC_CFGR2_OVSR | ADC_CFGR2_JOVSE | ADC_CFGR2_ROVSE));
...
ErrorStatus LL_ADC_REG_Init(ADC_TypeDef *ADCx,
	...
	if (ADC_REG_InitStruct->SequencerLength != LL_ADC_REG_SEQ_SCAN_DISABLE) {
		...
		assert_param(
				(ADC_REG_InitStruct->ContinuousMode == LL_ADC_REG_CONV_SINGLE) || (ADC_REG_InitStruct->SequencerDiscont == LL_ADC_REG_SEQ_DISCONT_DISABLE));
	}
	assert_param(
...
ErrorStatus LL_ADC_INJ_Init(ADC_TypeDef *ADCx,
	...
	if (ADC_INJ_InitStruct->SequencerLength != LL_ADC_INJ_SEQ_SCAN_DISABLE) {
		assert_param(
				IS_LL_ADC_INJ_SEQ_SCAN_DISCONT_MODE(ADC_INJ_InitStruct->SequencerDiscont));
	}
